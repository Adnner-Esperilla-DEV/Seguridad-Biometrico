...
public class FingerprintActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Inicializar Android Keyguard Manager y Fingerprint Manager
        ...
        // Compruebe si el dispositivo tiene un sensor de huellas dactilares
        if(!fingerprintManager.isHardwareDetected()){
            ...
            if (ActivityCompat.checkSelfPermission(this, Manifest.permission.USE_FINGERPRINT) != PackageManager.PERMISSION_GRANTED) {
                textView.setText("El permiso de autenticación de huellas dactilares no está habilitado");
            }else{
    ...
    public boolean cipherInit() {
        try {
            ...
            throw new RuntimeException("No se pudo obtener el cifrado", e);
        }
        ...
        try {
            ...
            throw new RuntimeException("No se pudo iniciar Cipher", e);
        }
    }
}
